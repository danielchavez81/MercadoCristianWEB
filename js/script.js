...
var p1 = about_div.appendChild(document.createElement("p"));
p1.innerHTML =
  "Somos el mercado de barrio más conocido de balsa las perlas especializado tanto en productos de almacen como articulos para el hogar.";
var p2 = about_div.appendChild(document.createElement("p"));
p2.innerHTML =
  "Este local comenzó como un emprendimiento de venta de helados ambulante, y gracias a mucho esfuerzo evolucionó para convertirse en lo que es ahora.";
//#endregion
...
var text_animation = new Typed("#animated_text", {
  strings: ["<q>David pecho frio</q>", "<q>texto de ejemplo</q>"],
  typeSpeed: "10",
  backSpeed: "5",
  loop: true,
  showCursor: false
